...
//: That's theory, in practice the delimitation between ImGuiWindow and ImGuiDrawContext is quite tenuous and could be reconsidered.
...
namespace ImGui
{
    ...
    //: All those functions are a mess and needs to be refactored into something decent. Avoid use outside of imgui.cpp!
