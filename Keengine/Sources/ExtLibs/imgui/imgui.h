...
namespace ImGui
{
    ...
    IMGUI_API void          ColorEditMode(ImGuiColorEditMode mode);                                 //: This is inconsistent with most of the API and will be obsoleted/replaced.
...
enum ImGuiTreeNodeFlags_
{
    ...
    //ImGuITreeNodeFlags_SpanAllAvailWidth  = 1 << 10,  //: Extend hit box horizontally even if not framed
    //ImGuiTreeNodeFlags_NoScrollOnOpen     = 1 << 11,  //: Disable automatic scroll on TreePop() if node got just open and contents is not visible
...
//: Will be replaced by future color/picker api
