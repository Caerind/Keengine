...
#include "Loading/WidgetSaver.hpp"
#include "Loading/WidgetLoader.hpp"
...
namespace tgui
{
    ...
    ///: Remove this function and move its contents to the focusWidget function above (requires change in Widget::focus)
